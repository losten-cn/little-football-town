...
const HomeScreenScene: PackedScene = preload("res://prototypes/training-match-loop-vertical-slice/screens/home_screen.tscn")
const TeamScreenScene: PackedScene = preload("res://prototypes/training-match-loop-vertical-slice/screens/team_screen.tscn")
const MatchScreenScene: PackedScene = preload("res://prototypes/training-match-loop-vertical-slice/screens/match_screen.tscn")
