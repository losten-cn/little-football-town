...
static func create_roster() -> Variant:
	var roster: Variant = PlayerRosterScript.new()
...
static func create_match_context(_roster: Variant, lineup_slots: Array) -> Dictionary:
...
static func create_post_match_settlement_context() -> Dictionary:
	return {
		"league_tier": 1,
